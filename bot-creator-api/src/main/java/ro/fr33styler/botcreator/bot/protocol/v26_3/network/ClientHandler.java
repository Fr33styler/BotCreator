package ro.fr33styler.botcreator.bot.protocol.v26_3.network;

import io.netty.channel.ChannelHandlerContext;
import io.netty.channel.ChannelInboundHandlerAdapter;
import ro.fr33styler.botcreator.bot.protocol.ClientOptions;
import ro.fr33styler.botcreator.bot.protocol.v26_3.network.packets.StageType;
import ro.fr33styler.botcreator.bot.protocol.v26_3.network.packets.common.AbstractDisconnectPacket;
import ro.fr33styler.botcreator.bot.protocol.v26_3.network.packets.configuration.*;
import ro.fr33styler.botcreator.bot.protocol.v26_3.network.packets.login.*;
import ro.fr33styler.botcreator.bot.protocol.v26_3.network.packets.play.*;
import ro.fr33styler.botcreator.bot.protocol.v26_3.network.packets.handshake.ServerBoundHandshakePacket;
...
public class ClientHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ctx.writeAndFlush(new ServerBoundHandshakePacket(777, options.getHost(), options.getPort(), 2));
    ...
    public void channelRead(ChannelHandlerContext ctx, Object msg) throws Exception {
        ...
        if (msg instanceof ClientBoundPlayerPositionPacket) {
            ctx.writeAndFlush(new ServerBoundAcceptTeleportationPacket((ClientBoundPlayerPositionPacket) msg));
        }
