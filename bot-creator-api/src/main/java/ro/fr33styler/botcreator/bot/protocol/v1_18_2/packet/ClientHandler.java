...
import ro.fr33styler.botcreator.bot.protocol.v1_18_2.packet.packets.handshake.HandshakePacket;
import ro.fr33styler.botcreator.bot.protocol.v1_18_2.packet.packets.login.LoginStartPacket;
import ro.fr33styler.botcreator.bot.protocol.v1_18_2.packet.packets.login.LoginSuccessPacket;
import ro.fr33styler.botcreator.bot.protocol.v1_18_2.packet.packets.login.SetCompressPacket;
...
public class ClientHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ctx.writeAndFlush(new HandshakePacket(758, options.getHost(), options.getPort(), 2));
