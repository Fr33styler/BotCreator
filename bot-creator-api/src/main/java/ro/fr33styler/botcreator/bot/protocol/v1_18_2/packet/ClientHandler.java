package ro.fr33styler.botcreator.bot.protocol.v1_18_2.packet;
...
import ro.fr33styler.botcreator.bot.protocol.v1_18_2.packet.packets.common.AbstractDisconnectPacket;
import ro.fr33styler.botcreator.bot.protocol.v1_18_2.packet.packets.handshake.ServerBoundHandshakePacket;
import ro.fr33styler.botcreator.bot.protocol.v1_18_2.packet.packets.login.ServerBoundLoginStartPacket;
import ro.fr33styler.botcreator.bot.protocol.v1_18_2.packet.packets.login.ClientBoundLoginSuccessPacket;
import ro.fr33styler.botcreator.bot.protocol.v1_18_2.packet.packets.login.ClientBoundSetCompressPacket;
import ro.fr33styler.botcreator.bot.protocol.v1_18_2.packet.packets.play.*;
...
public class ClientHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ctx.writeAndFlush(new ServerBoundHandshakePacket(758, options.getHost(), options.getPort(), 2));
