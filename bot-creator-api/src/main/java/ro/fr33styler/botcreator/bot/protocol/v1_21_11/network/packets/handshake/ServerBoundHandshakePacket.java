package ro.fr33styler.botcreator.bot.protocol.v1_21_11.network.packets.handshake;
...
public class ServerBoundHandshakePacket implements Packet {
    ...
    public ServerBoundHandshakePacket(int version, String host, int port, int intent) {
