...
public class StagePlay implements Stage {
    ...
    public StagePlay() {
        ...
        packets.put(0x35, ClientBoundRespawnScreenPacket::new);
        packets.put(0x38, ClientBoundPlayerPositionPacket::new);
        packets.put(0x3C, ClientBoundResourcePackPushPacket::new);
