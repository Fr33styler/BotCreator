package ro.fr33styler.botcreator.bot.protocol.v1_8_9.network;
...
import ro.fr33styler.botcreator.bot.protocol.v1_8_9.network.packets.login.ServerBoundLoginStartPacket;
import ro.fr33styler.botcreator.bot.protocol.v1_8_9.network.packets.login.ClientBoundLoginFinishedPacket;
import ro.fr33styler.botcreator.bot.protocol.v1_8_9.network.packets.login.ClientBoundLoginCompressionPacket;
import ro.fr33styler.botcreator.bot.protocol.v1_8_9.network.packets.play.*;
...
public class ClientHandler extends ChannelInboundHandlerAdapter {
    ...
    public void channelActive(ChannelHandlerContext ctx) throws Exception {
        ctx.writeAndFlush(new ServerBoundHandshakePacket(47, options.getHost(), options.getPort(), 2));
